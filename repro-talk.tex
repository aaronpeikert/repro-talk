...
\author{\href{https://github.com/aaronpeikert/}{Aaron Peikert\textsuperscript{1,2}\\}}
\institute{
...
\begin{frame}[c]{Problems}
	\onslide<1->\textcolor<2->{lolit}{How do I generate this plot, table, result?}\\
	\onslide<2->\textcolor<3->{lolit}{Is this the correct version of the data and code?}\\
	\onslide<3->\textcolor<4->{lolit}{How do I run this code? Do I have all files neccesary?}\\
	\onslide<4>What software/packages do I need and how do I install them?
\end{frame}
...
\begin{frame}[c]{Lessons from software engeniering}
  \begin{itemize}
    \item Code \textemdash{} document = dynamic document generation
  ...
  \end{itemize}
	\vfill
	\textcolor{lolit}{\tiny Peikert, A., \& Brandmaier, A. M. (2019). A Reproducible Data Analysis Workflow with R Markdown,
Git, Make, and Docker [Preprint].PsyArXiv. https://doi.org/10.31234/osf.io/8xzqy}
\end{frame}
