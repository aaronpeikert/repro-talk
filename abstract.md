...
Big data applications particulary are threatened by non-reproducibility because data often come from multiple sources, are large and messy and preprocessing may rely on multiple software packages.
